...
const serviceLinks = [
  ...
  { label: "Vehicle Detailing", href: "/services/vehicle-detailing" },
  { label: "Car Wrapping", href: "/services/car-wrapping" },
  { label: "Paint Protection Film", href: "/services/paint-protection-film" },
  { label: "3 Stage Polishing", href: "/services/3-stage-polishing" },
]
    ...
    <footer className="bg-surface border-t border-surface-border" aria-label="Site footer">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link
              href="/"
              className="inline-block font-display text-3xl text-white uppercase tracking-wider mb-4
                hover:text-brand-blue transition-colors duration-200
                focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue"
              aria-label="MoonShine — home"
            >
              Moon<span className="text-brand-blue">Shine</span>
            </Link>
            <p className="text-muted text-sm leading-relaxed mb-6">
              Dublin&apos;s premier window tinting, car valeting and vehicle enhancement specialist. Serving all of Dublin with ceramic-grade films and expert workmanship.
            </p>
            {/* Social icons */}
          ...
          <div>
            ...
            <ul className="space-y-4" role="list">
              <li className="flex items-start gap-3">
                <svg className="w-4 h-4 text-brand-blue mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                ...
                <span className="text-muted text-sm">{CONTACT.address}</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-4 h-4 text-brand-blue mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <a href={CONTACT.phoneTel} className="text-muted text-sm hover:text-white transition-colors duration-200">{CONTACT.phone}</a>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-4 h-4 text-brand-blue mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                ...
                <a href={`mailto:${CONTACT.email}`} className="text-muted text-sm hover:text-white transition-colors duration-200">{CONTACT.email}</a>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-4 h-4 text-brand-blue mt-0.5 shrink-0" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div className="border-t border-surface-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row
          items-center justify-between gap-3 text-xs text-muted">
