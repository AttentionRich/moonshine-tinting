  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-hidden="true"
      >
        <div className="w-[600px] h-[300px] bg-brand-blue/15 rounded-full blur-[100px]" />
      </div>
      <div
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3
              border border-whatsapp text-whatsapp text-sm font-semibold uppercase tracking-widest
              px-8 py-4 hover:bg-whatsapp hover:text-white transition-colors duration-200
